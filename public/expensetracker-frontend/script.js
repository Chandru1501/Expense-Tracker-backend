...
async function postUser(myObj){
  console.log(myObj);
 axios.post("https://chandraprakash.tech/user/add-user",myObj)
 .then((response)=>{
    console.log(response);
    location.replace('https://chandraprakash.tech/login.html') })
 .catch((err)=>{
...
axios.post('https://chandraprakash.tech/user/login',myLogin)
.then((response)=>{
    console.log(response);
    if(response.data.status=="login Successfull"){
        if(localStorage.getItem("token")==null && localStorage.getItem('username')==null){
            ...
            location.replace('https://chandraprakash.tech/expensetracker-frontend/expenses/expense.html')
        }
        else{
...
async function postNow(resetemail){
  try{
  let response = await axios.post('https://chandraprakash.tech/password/forgotpassword',resetemail)
  console.log(response);
